...
locate-anything, nafnet -- is spawned by this server, so one process-wide lock
is all that is needed to keep two of them from competing for the same VRAM. It is a
