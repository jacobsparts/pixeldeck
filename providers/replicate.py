...
async def go_replicate(request, post, deliver_bin_image, api_token):
    def replicate_req(model, url, mask_url=None):
        return {
            ...
            'nafnet: Image Denoising': { "version": "018241a6c580494552e382236173f9166946695b6baa4e100cfb638927409c2a", "input": { "image": url, "task_type": "Image Denoising" } },
            'nafnet: Image Debluring (GoPro)': { "version": "018241a6c580494552e382236173f9166946695b6baa4e100cfb638927409c2a", "input": { "image": url, "task_type": "Image Deblurring (GoPro)" } },
            'nafnet: Image Debluring (REDS)': { "version": "018241a6c580494552e382236173f9166946695b6baa4e100cfb638927409c2a", "input": { "image": url, "task_type": "Image Deblurring (REDS)" } },
    ...
    register('Replicate', 'Enhance', {
        'model': {
            'options': [
                ...
                'nafnet: Image Debluring (GoPro)',
                'nafnet: Image Debluring (REDS)',
            ],
